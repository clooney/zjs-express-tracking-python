...
#urlStr = ""
#requestData = "{\"tracking_number\":\"A000644586305\"}"
...
#urlStr = "?page=1&limit=100&created_at_min=&created_at_max=&update_time_min=&update_time_max=&order_created_time_min=&order_created_time_max=&numbers=A000644586305&orders=&lang=en"
#requestData = ""
#result = tracker.trackingmore(requestData, urlStr, "get")

#5 Get tracking results of a single tracking.
#urlStr = "/zjs-express/A000644586305/en"
#requestData = ""
...
#urlStr = "/zjs-express/A000644586305"
...
#urlStr = ""
#requestData = "{\"tracking_number\": \"A000644586305\",\"carrier_code\":\"zjs-express\",\"destination_code\":\"US\",\"tracking_ship_date\": \"20180908\",\"tracking_postal_code\":\"12201\",\"specialNumberDestination\":\"UK\",\"order\":\"#123\",\"order_create_time\":\"2018/09/08 16:51\",\"lang\":\"en\"}"
#result = tracker.trackingmore(requestData, urlStr, "realtime")

#10 Modify courier code(修改运输商)
#urlStr = ""
#requestData = "{\"tracking_number\": \"A000644586305\",\"carrier_code\":\"zjs-express\",\"update_carrier_code\":\"china-ems\"}"
...
#urlStr = ""
#requestData = "[{\"tracking_number\":\"A000644586305\",\"carrier_code\":\"zjs-express\"},{\"tracking_number\":\"LZ448865302CN\",\"carrier_code\":\"zjs-express\"}]"
...
#urlStr = ""
#requestData = "[{\"carrier_code\":\"zjs-express\",\"destination\":\"US\",\"original\":\"CN\"},{\"carrier_code\":\"china-ems\",\"destination\":\"US\",\"original\":\"CN\"}]"
#result = tracker.trackingmore(requestData, urlStr, "costtime")

#16 Delete multiple tracking item(批量删除)
#urlStr = ""
#requestData = "[{\"tracking_number\":\"A000644586305\",\"carrier_code\":\"zjs-express\"},{\"tracking_number\":\"LZ448865302CN\",\"carrier_code\":\"china-ems\"}]"
